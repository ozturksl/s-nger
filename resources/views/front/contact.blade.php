            ...
            <div class="row py-4 py-lg-5 px-3 g-4">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="ratio ratio-16x9 h-100 min-vh-50">
                        <iframe src="{{ $content->ct_harita }}" allowfullscreen="" loading="lazy"
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="rounded-4 bg-light p-4 contact-links h-100">
                        ...
                        <ul class="ps-0 mb-0">
                            <li class="mb-3"><a href="#" class="d-flex align-items-start text-dark h6 text-wrap"><i
                                        class="bi bi-geo-alt-fill text-danger me-2 mt-1"></i><span>{{ $content->ct_address }}</span></a>
                            </li>
                            <li class="mb-3"><a href="tel:+90{{ $content->ct_number1 }}"
                                    class="d-flex align-items-center text-dark h6"><i
                                        class="bi bi-telephone-fill text-danger me-2"></i><span>+90{{ $content->ct_number1 }}</span></a>
                            </li>
                            <li class="mb-3"><a href="tel:+90{{ $content->ct_number2 }}"
                                    class="d-flex align-items-center text-dark h6"><i
                                        class="bi bi-telephone-fill text-danger me-2"></i><span>+90{{ $content->ct_number2 }}</span></a>
                            </li>
                            <li class="mb-0"><a href="mailto:{{ $content->ct_mail }}"
                                    class="d-flex align-items-center text-dark h6 text-break"><i
                                        class="bi bi-envelope-fill text-danger me-2"></i><span>{{ $content->ct_mail }}</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
