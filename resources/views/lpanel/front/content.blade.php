                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-4">
                            <div class="mb-4">
                                ...
                                <input type="url" class="form-control custom-border" placeholder="Link giriniz."
                                    value="">
                            </div>
                            <div class="mb-4">
                                <label for="" class="form-label fw-bold">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control custom-border" placeholder="Adres giriniz."
                                    value="">
                            </div>
                            <div class="mb-4">
                                <label for="" class="form-label fw-bold">
                                ...
                                <input type="mail" class="form-control custom-border" placeholder="Mail giriniz."
                                    value="">
                            </div>
