    ...
    <div class="container-fluid px-3 px-lg-5">
        <div class="row g-4 justify-content-lg-between text-center text-lg-start">
            ...
            <div class="col-lg-3 col-12 footer-first">
                ...
                <p class="text-white-50 mt-3small">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    Lorem Ipsum has been the industry's standard dummy</p>
                <ul class="d-flex gap-3 icons p-0 justify-content-center justify-content-lg-start mt-4 list-unstyled">
                    <li><a href="#" class="opacity-75 opacity-100-hover"><i class="bi bi-whatsapp fs-5"></i></a></li>
                    <li><a href="#" class="opacity-75 opacity-100-hover"><i class="bi bi-instagram fs-5"></i></a></li>
                    <li><a href="#" class="opacity-75 opacity-100-hover"><i class="bi bi-linkedin fs-5"></i></a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-12 footer-last text-break">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt-fill me-2 text-danger"></i>Atatürk Bulvarı No:123, Çankaya, Ankara</p>
                <p class="mb-2"><i class="bi bi-telephone-fill me-2 text-danger"></i>+90 312 123 45 67</p>
                <p class="mb-0"><i class="bi bi-envelope-fill me-2 text-danger"></i>info@company.com</p>
            </div>
