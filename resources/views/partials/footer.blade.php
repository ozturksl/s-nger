            ...
            <div class="col-lg-3 col-12 footer-first">
                ...
                <ul class="d-flex gap-3 icons p-0 justify-content-center justify-content-lg-start mt-4 list-unstyled">
                    @foreach ($content as $contents)
                        <li><a href="https://wa.me/90{{ $contents->ct_number1 }}" target="_blank" class="opacity-75 opacity-100-hover"><i
                                    class="bi bi-whatsapp fs-5"></i></a>
                        </li>
                        <li><a href="{{ $contents->ct_instagram }}" target="_blank" class="opacity-75 opacity-100-hover"><i
                                    class="bi bi-instagram fs-5"></i></a>
                        </li>
                        <li><a href="{{ $contents->ct_linkedin }}" target="_blank" class="opacity-75 opacity-100-hover"><i
                ...
                @foreach ($content as $contents)
                    <address class="text-secondary font-style-normal mb-3">
                        <div class="d-flex align-items-start mb-2">
                            ...
                            <span>{{ $contents->ct_address }}</span>
                        </div>
                        <a href="tel:+90{{ $contents->ct_number1 }}"
                            class="text-secondary text-decoration-none d-block mb-2">
                            <i class="bi bi-telephone-fill me-2 text-danger"></i>+90{{ $contents->ct_number1 }}
                        </a>
                        @if ($contents->ct_number2)
                            <a href="tel:+90{{ $contents->ct_number2 }}"
                                class="text-secondary text-decoration-none d-block mb-2">
                                <i class="bi bi-telephone-fill me-2 text-danger"></i>+90{{ $contents->ct_number2 }}
                            </a>
                        @endif
                        <a href="mailto:{{ $contents->ct_mail }}"
                            class="text-secondary text-decoration-none d-block mb-0">
                            <i class="bi bi-envelope-fill me-2 text-danger"></i>{{ $contents->ct_mail }}
                        </a>
                    </address>
                @endforeach
            </div>
